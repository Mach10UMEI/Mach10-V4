...
//*** extend home -3 to -40
  ...
  public void execute() {
    ...
    if(RobotContainer.extend.get_extend_encoder() <= -32 && speed<0.0){
      speed = 0.0;
    }else if(RobotContainer.extend.get_extend_encoder() >= -1 && speed>0.0){
      speed = 0.0;
    }

    RobotContainer.extend.extend(speed*0.90);
